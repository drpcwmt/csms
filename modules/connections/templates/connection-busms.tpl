  ...
  <table border="0" cellspacing="0">
    <tbody>
      <tr>
        ...
        <td valign="top"><span class="buttonSet">
          <input class="ui-corner-right" name="acc_server" id="acc_server1" [@acc_server_on] value="1" type="radio">
          <label for="acc_server1">[#on]</label>
          
          <input name="acc_server" id="acc_server0" value="0" [@acc_server_off] type="radio">
          <label for="acc_server0">[#off]</label>
          </span></td>
      </tr>
      <tr>
        <td class="reverse_align" valign="middel" width="120"><label class="label ui-widget-header ui-corner-left reverse_align">IP</label></td>
