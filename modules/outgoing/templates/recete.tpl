<page>
	<page_header class="page_header">
    	<img src="attachs/img/header.jpg" width="100%" />
    </page_header>
    <div class="ui-widget-content receipt" >
        <h4>[#date]: [@date]</h4>
        <h4>[#recete_no]: [@no]</h4>
      <h2 style="text-align:center">[@receipt_title]</h2>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
              <tr>
                ...
                <td valign="middle">
                    <div class="ui-widget-content ui-corner-all" style="padding:4px; font-weight:bold">[@from_name]</div>
                  
                </td>
                <td width="120" valign="middle">
                    <div class="ui-widget-content ui-corner-all" style="padding:4px; font-weight:bold">[@from_code]</div>
                </td>
              </tr>
              <tr>
        ...
        <table width="100%">
        	<tr>
                <td valign="top">
                	<h4  class="def_align">[#signature]:</h4>
                </td>
            	<td valign="top">
