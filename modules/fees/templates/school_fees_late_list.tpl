<form class="ui-widget-content ui-corner-bottom transparent_div" id="late_form">
	...
	<fieldset class="ui-state-highlight">
        <table border="0" cellspacing="0">
          ...
          <tr>
          <td width="120" valign="middel">
                <label class="label ui-widget-header ui-corner-left reverse_align" >[#payment]</label>
            </td>
            <td width="200">
                <select name="date" class="combobox">
                    [@dates_opts]
                </select>
            </td>
          	<td colspan="3">
            	<label><input type="checkbox" name="none_paid" value="1" />[#non_paid_only]</label>
            </td>
       </table> 
 	</fieldset>
