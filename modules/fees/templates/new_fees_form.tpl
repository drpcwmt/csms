<form>
              ...
              <tr>
                ...
                <td valign="top">
                   <span class="buttonSet">
                      ...
                      <input name="discount" id="discount_off" checked value="0" type="radio" />
	...
	<div class="[@applytohidden]">
        <div class="toolbox">
            <a action="applyFeesToall" title="[#apply_to_all]">[#apply_to_all]<span class="ui-icon ui-icon-disk"></span></a>
        </div>
        <table class="tableinput">
            <thead>
                <tr>
