        ...
        <tr>
            <td width="300" valign="top">
                <div class="toolbox">
                    ...
                    <a action="newDriver"> <span class="ui-icon ui-icon-plus"></span></a>
                    <a action="importDrivers"> <span class="ui-icon ui-icon-transferthick-e-w"></span></a>
                </div>
            ...
            <td id="driver_content" valign="top">
                [@driver_layout]
            </td>
        </tr>
    </table>
