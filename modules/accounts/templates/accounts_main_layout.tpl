<div class="tabs">
	<ul>
    	<li><a href="#acc_[@full_code]-details">[#info]</a></li>
        <li><a href="index.php?module=accounts&subs&acc=[@full_code]">[#sub_code]</a></li>
    </ul>
    <div id="acc_[@full_code]-details" class="ui-widget-content transparent_div scoop">
    	<form class="account_infos">
        	<div class="toolbox">
            	<a module="accounts" action="saveMainCode" title="[#save]">[#save]<span class="ui-icon ui-icon-disk"></span></a>
                <a module="accounts" action="deleteMainCode" title="[#delete]">[#delete]<span class="ui-icon ui-icon-close"></span></a>
                ...
                <table width="100%" cellspacing="0" border="0">
                  <tbody>
                    <tr>
                      ...
                      <td width="60"><span class="account_code" style="width:105px;float:right">
