...
CREATE TABLE IF NOT EXISTS `events_label` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `exams` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=23492 ;

CREATE TABLE IF NOT EXISTS `exams_makeup` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gradding` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(16) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4 ;

CREATE TABLE IF NOT EXISTS `gradding_points` (
...
CREATE TABLE IF NOT EXISTS `levels` (
  ...
  `name_ar` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `name_en` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `materials` (
  ...
  `prof_ids` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `materials_profs` (
...
CREATE TABLE IF NOT EXISTS `schedules_date` (
  ...
  `date` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=11040 ;
...
CREATE TABLE IF NOT EXISTS `schedules_lessons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=14734 ;
...
CREATE TABLE IF NOT EXISTS `services` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=575 ;
