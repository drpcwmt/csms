<h2 class="title">[#permissionout]</h2>
<div class="tabs">
	<ul> 
    	<li><a href="#permissionout_insert_tab">[#add]</a></li>
        <li><a href="#permissionout_report_tab">[#reports]</a></li>
    </ul>
    <div id="permissionout_insert_tab">
        <table width="100%">
            <tr>
                ...
                <td valign="top">
                	<div class="toolbox">
                    	<a action="addPermissionout" class="[@add_permissionout_hidden]"><span class="ui-icon ui-icon-plus"></span>[#add]</a>
                        <a action="print_tab"><span class="ui-icon ui-icon-print"></span>[#print]</a>
                    </div>
                    <form class="ui-state-highlight" id="permissionout_form"> 
                    	<input type="hidden" name="job_id" id="permissionout_job_id" value="[@job_id]" />		
                        <table width="100%" cellspacing="1" cellpadding="0" border="0">
                            <tr>
                                <td width="120"><label class="label ui-widget-header ui-corner-left reverse_align">[#date]</label></td>
                                <td colspan="3">
                                    <input type="text" name="date" value="[@today]" class="datepicker mask-date" update="openPermissionoutByJob" />
                              </td>
                            </tr>
                        </table>
                    </form>                    
                    <table class="tablesorter">
                        <thead>
                            <tr>
                                ...
                                <th width="80" class="{sorter:false}">[#value]</th>
                            </tr>
                        </thead>
                        <tbody id="permissionout_daily_tbody">
                            [@daily_trs]
                        </tbody>
                    </table>                
				</td>
    ...
    <div id="permissionout_report_tab">
    	<div class="toolbox">
        	<a action="print_tab"><span class="ui-icon ui-icon-print"></span>[#print]</a>
        </div>
    	<h2 class="showforprint hidden" align="center">[#permissionout_report]</h2>
        ...
        <table class="tablesorter">
            ...
            <tbody id="permissionout_list_tbody">
                [@report_trs]       
            </tbody>
        </table>    
    </div>
