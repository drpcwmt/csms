<form id="permissionout_add_form">
	<fieldset>
        <table width="100%" cellspacing="0">
            ...
            <tr>
               ...
               <td><input type="text" class="mask-time input-half" name="end" value="[@end_time]" /></td>
            </tr>
            <tr>
               <td><label class="label ui-widget-header ui-corner-left reverse_align">[#discount]</label></td>
               <td><input type="text" class="half_input" name="value" value="[@value]" /> [#day]</td>
            </tr>
            <tr>
              <td valign="top">
